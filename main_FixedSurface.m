...
% RecLength =struct('L_x',12*lambda,'L_y',12*lambda,'distance',[6,4,2]);
% Nr_X=RecLength.L_x/RecSpacing;Nr_Y=RecLength.L_y/RecSpacing;
% % The length of transmitted  surface
% TraLength=struct('L_x',16*lambda,'L_y',16*lambda,'distance',[0,0,0]);
% Ns_X=TraLength.L_x/TraSpacing;Ns_Y=TraLength.L_y/TraSpacing;
...
dim = [.2 .3 .3 .3];
str = '$L_{s,x}=16\lambda,L_{s,y}=16\lambda,L_{r,x}=12\lambda,L_{r,y}=12\lambda$';
