function [BFMatrix,MMSE]=BFSchemes_MMSE_noinverse(ChannelPhase,var_noise)
 
%% %MMSE for Perfect channels
P =1/var_noise; %Linear scale
 
GramMatrix=ChannelPhase*ChannelPhase'+  var_noise * eye(size(ChannelPhase,1));
BFMatrix=ChannelPhase'*NeumannApprox(GramMatrix,1);
